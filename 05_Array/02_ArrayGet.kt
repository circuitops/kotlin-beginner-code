...
fun main(){
    ...
    val firstStudId = studId.get(0)     //Get studId array element at index 0
    val thirdStudId = studId.get(3)      //Get studId array element at index 3

    val firstStudLastName = studLastName.get(0)     //Get studLastName array element at index 0
    val thirdStudLastName = studLastName.get(3)      //Get studLastName array element at index 3
